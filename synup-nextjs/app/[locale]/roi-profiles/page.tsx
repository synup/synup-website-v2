...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: "roi-profiles — Synup",
    description: "Learn about roi-profiles at Synup.",
    alternates: { canonical: `${baseUrl}${locale === "en" ? "/roi-profiles" : `/${locale}/roi-profiles`}` },
  };
}
