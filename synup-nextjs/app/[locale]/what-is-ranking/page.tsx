...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: "what-is-ranking — Synup",
    description: "Learn about what-is-ranking at Synup.",
    alternates: { canonical: `${baseUrl}${locale === "en" ? "/what-is-ranking" : `/${locale}/what-is-ranking`}` },
  };
}
